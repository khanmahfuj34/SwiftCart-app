        ...
        <View style={styles.container}>
          ...
          <Animated.View style={[styles.formContainer, { opacity: fadeAnim, transform: [{ translateX: errorShake }] }]}>
            ...
            <TouchableOpacity 
              ...
              disabled={!isFormValid && password.length === 0 && email.length === 0} // Only disabled physically if empty, else shaky error handles it
            >
              <Animated.View style={[styles.loginButtonWrapper, { transform: [{ scale: btnScale }] }]}>
                {isFormValid ? (
                  ...
                  <View style={[styles.loginButtonGradient, styles.loginButtonDisabled]}>
                    <Text style={styles.loginButtonDisabledText}>SIGN IN</Text>
                  </View>
                )}
              </Animated.View>
            </TouchableOpacity>
            ...
            <View style={styles.socialContainer}>
              ...
              >
                <Animated.View style={[styles.socialBtnLight, { transform: [{ scale: googleScale }] }]}>
              ...
              <TouchableOpacity 
                 ...
                 style={styles.socialBtnBase}
              >
                <Animated.View style={[styles.socialBtnDark, { transform: [{ scale: appleScale }] }]}>
            ...
            <View style={styles.bottomTextContainer}>
              ...
              <TouchableOpacity onPress={() => router.push('/signup')}>
                <Text style={styles.bottomTextHighlight}>Create Account ✨</Text>
              </TouchableOpacity>
            </View>
          </Animated.View>
